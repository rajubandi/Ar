			...
			<div class="col-xl-12">
				<div class="container" ng-app="app">
					...
					<div ng-controller="saveSite">
						<form class="form-horizontal" name="siteForm" id="customerForm"
							ng-submit="siteForm()">
							<div class="form-group">
								<label class="control-label col-sm-2" for="vId">Village
									Name:</label>
								<div class="col-sm-5">
									<select class="form-control" id="villageId"
										ng-options="k as v for (k, v) in villageId" name="vId"
										ng-model="site.vId">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" name="colony"
										id="colony" placeholder="Enter FirstName"
										ng-model="site.colony" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="pinCode">Sq
									Yd:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="sqYd" id="sqYd"
										placeholder="Enter Sq Yd" ng-model="site.sqYd" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" name="price" id="price"
										placeholder="Enter Price" ng-model="site.price" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="propertyType">Property
									Type:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="propertyType"
										id="propertyType" placeholder="Enter Property Type"
										ng-model="site.propertyType" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="listingId">Listing
									Id:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="listingId"
										id="listingId" placeholder="Enter Listing Id"
										ng-model="site.listingId" />
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									...
									<button type="button" ng-click="ctrl.reset()"
										...
										ng-disabled="siteForm.$pristine">Reset Form</button>
								</div>
							</div>
						</form>
									...
									<table class="table table-hover" datatable="ng"
										...
										<tbody>
											<tr ng-repeat="u in siteTable">
												...
												<td><button type="button" ng-click="editSite({{u.id}})"
														class="btn btn-success custom-width">Edit</button></td>
												<td><button type="button"
														ng-click="removeSite({{u.id}})"
