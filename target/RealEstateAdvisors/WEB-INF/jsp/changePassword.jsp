		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4>
						<i class="fa  fas fa-key "> Change Password</i>
					</h4>
					<div class="options">
				...
				<div class="panel-body collapse in">
					...
					<div class="page-body">
						<form:form modelAttribute="changePassword" action="changePassword"
							class="form-horizontal" method="Post">

							<div class="col-md-6">
								<div class="form-group" id="passwordDiv">
									<label class="col-md-3 control-label no-padding-right">Current
										Password<span class="impColor">*</span>
									</label>
									<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group" id="passwordDiv">
									...
									<div class="col-md-6">
										<form:password path="npassword" class="form-control validate"
							...
							<div class="col-md-6">
								<div class="form-group" id="passwordDiv">
									...
									<div class="col-md-6">
										<form:password path="cpassword" class="form-control validate"
							...
							<div class="col-md-12" style="text-align: right;">
								<div class="form-group">
									<div class="col-md-offset-3 col-md-6">
										<input type="submit" id="submit4" class="btn btn-success"
											value="Submit" /> <input class="btn-danger btn cancel"
