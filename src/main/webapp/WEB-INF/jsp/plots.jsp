...
.header-section {
            ...
            <div class="careerfy-main-section ">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="bbgwhite">
                          <p align="center" >Total : 300 | <span class="resi">Residential : 150 </span>| <span class="comm">Commercial : 150</span></p>
                        ...
                        <aside class="careerfy-column-3 careerfy-typo-wrap">
                            <div class="careerfy-typo-wrap">
                                <form class="careerfy-search-filter">
                                    ...
                                    <div class="careerfy-search-filter-wrap careerfy-search-filter-toggle">
                                        <h2><a href="#" class="careerfy-click-btn">Plot Facing</a></h2>
                                        <div class="careerfy-checkbox-toggle">
                                            <ul class="careerfy-checkbox">
                                                <li>
                                                    <input type="checkbox" id="r17" name="rr" />
                                                    <label for="r17"><span></span>North</label>
                                                    <small>10</small>
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="r18" name="rr" />
                                                    <label for="r18"><span></span>South</label>
                                                    <small>2</small>
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="r19" name="rr" />
                                                    <label for="r19"><span></span>East</label>
                                                    <small>6</small>
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="r20" name="rr" />
                                                    <label for="r20"><span></span>West</label>
                                                    <small>4</small>
                                                </li>
                                    ...
                                    <div class="careerfy-search-filter-wrap careerfy-search-filter-toggle">
                                        <h2><a href="#" class="careerfy-click-btn">Price / Sq.Yd</a></h2>
                                        <div >
 ...
 <input name="" type="text" class="form-control" value="25000"><br>
                                                        ...
                                                        <a href="#" class="careerfy-option-btn careerfy-red" style="margin-top:10px;">Submit</a>
